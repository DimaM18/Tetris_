...
namespace Client.Scripts.DataStorage
{
    public class Meta
    {
        ...
        public readonly float[] RotationMatrix = { Cos, Sin, -Sin, Cos };
        
        //https://tetris.fandom.com/wiki/Tetromino
        public readonly Dictionary<TetrominoType, Vector2Int[]> Cells = new()
        {
        ...
        public readonly Dictionary<TetrominoType, Vector2Int[,]> WallKicks = new()
        {
            { TetrominoType.I, WallKicksI },
            { TetrominoType.J, WallKicksOther },
            { TetrominoType.L, WallKicksOther },
            { TetrominoType.O, WallKicksOther },
            { TetrominoType.S, WallKicksOther },
            { TetrominoType.T, WallKicksOther },
            { TetrominoType.Z, WallKicksOther },
        };
